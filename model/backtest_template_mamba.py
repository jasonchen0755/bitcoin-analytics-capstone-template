...
from model.prelude_template_mamba import (
...
# -------------------------------------------------------------------------------------- #
#   Copied from template.backtest_template.py                                            #
#   Because Mamba output signals in a rolling manner, function run_full_analysis revised.#
#   Function run_full_analysis now takes computed signal_dict as input, not feature_df.  #
#   Pre-computed signal_dict was saved as data/dca/mamba_signals.json.                   #
#   Mamba installation and cuda are needed to recompute singals.                         #
# -------------------------------------------------------------------------------------- #             
...
def run_full_analysis(
    btc_df: pd.DataFrame,
    signal_dict: dict, # change from pd.DataFrame to dict by my model design
    compute_weights_fn,
    output_dir: Path | str = 'model/output_mamba',
